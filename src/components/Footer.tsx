      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 md:flex-row md:items-end md:justify-between">
        <div>
          <div className="flex items-center gap-2">
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-brand text-sm font-black text-white">瞬</span>
            <div>
              <strong className="brand-mark">瞬懂</strong>
              <p className="text-sm text-muted">让每个点位都有人教，也有地方讨论。</p>
            </div>
          </div>
          <p className="mt-3 max-w-lg text-xs text-muted">
            跟随歪歪滴艾斯一键装扮。玩家社区作品，与拳头游戏 / 无畏契约官方无关联。
          </p>
        </div>
        <div className="flex flex-wrap gap-4 text-sm text-muted">
          <a href="https://www.yydsxwh.com/products">产品中心</a>
